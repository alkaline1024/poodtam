...
ANYPRICE_CORPUS = ["all","all price","anyprice","any price","any","every price","anyprice",]
LOW_PRICE_CORPUS = ["฿","lowest","low","lower","less","min","minimun","less than 100 baht","cheap", "cheapest"]
MEDIUM_PRICE_CORPUS = ["฿฿","medium","medium","average","normal","betweem 100 baht and 250 baht",]
HIGH_PRICE_CORPUS = ["฿฿฿","highest","higher","high","maximum","max","more than 250 baht",]
PRICE_CORPUS = (LOW_PRICE_CORPUS + MEDIUM_PRICE_CORPUS + HIGH_PRICE_CORPUS + ANYPRICE_CORPUS)

# *** TIME DATASET ***
ANYTIME_CORPUS = ["anytime","alltime","allday","all day","everytime"]
NOW_TIME_CORPUS = ["now","currently","today",]
SPECIFIC_TIME_CORPUS = ["select","select time","choose","i'll choose","ill choose","i will choose","choose myself","myself","specific", "specifictime"]
BREAKFAST_CORPUS = ["breakfast","morning",]
LUNCH_CORPUS = ["lunch","noon",]
DINNER_CORPUS = ["evening", "afternoon","dinner","night","midnight",]
